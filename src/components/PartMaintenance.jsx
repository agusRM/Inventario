  ...
  return (
    <div className="inventory-card">
      ...
      <form ref={formRef} className="maintenance-form" onSubmit={handleSubmit}>
        ...
        <div className="field"><label htmlFor="part-models">Modelos compatibles <span className="optional-field">(opcional)</span></label><input id="part-models" value={form.compatible_models} onChange={(event) => updateField("compatible_models", event.target.value)} /></div>
        <div className="field"><label htmlFor="part-years">Años <span className="optional-field">(opcional)</span></label><input id="part-years" value={form.years} onChange={(event) => updateField("years", event.target.value)} /></div>
        ...
        <div className="field"><label htmlFor="part-shelf">Anaquel <span className="optional-field">(opcional)</span></label><input id="part-shelf" value={form.shelf} onChange={(event) => updateField("shelf", event.target.value)} /></div>
